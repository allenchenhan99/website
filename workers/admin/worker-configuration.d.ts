/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/admin/wrangler.jsonc workers/admin/worker-configuration.d.ts` (hash: b07a045d9b1af3f1a40298e90fafc033)
// Runtime types generated with workerd@1.20260831.1 2026-09-03 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	ADMIN_EMAIL: "allenchenhan99@gmail.com";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMIN_EMAIL" | "GITHUB_OWNER" | "GITHUB_REPO" | "GITHUB_BRANCH">> {}
}
