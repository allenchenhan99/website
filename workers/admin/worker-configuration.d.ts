/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/admin/wrangler.jsonc workers/admin/worker-configuration.d.ts` (hash: 4387b8aef9ba6106b4b70df3eadcce4a)
